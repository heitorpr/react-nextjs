...
from src.web.deps.repositories import get_user_repository, get_permission_repository, get_user_permission_repository
...
def get_user_service(
    ...
    return UserService(user_repository=user_repository, user_permission_repository=user_permission_repository)
